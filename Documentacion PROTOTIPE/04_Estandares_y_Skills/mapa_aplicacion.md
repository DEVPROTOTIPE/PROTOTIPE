...
* **`/git_backup.ps1`**: Script de PowerShell para automatizar copias de seguridad (Git Backup) completas de todo el ecosistema (Maestro), deteniendo y reanudando servidores de desarrollo para evitar bloqueos de archivos.
* **`/subproject_backup.ps1`**: Script de PowerShell para realizar respaldos Git y commits automáticos/personalizados en subproyectos específicos sin requerir prompts interactivos si es invocado por la API.
