      ...
      {!isOpen && !cierreCompletado && (
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 shadow-lg max-w-md mx-auto space-y-6">
          ...
          <form onSubmit={handleOpenShift} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-indigo-600 hover:bg-indigo-500 active:scale-98 transition-all rounded-xl text-[var(--color-text)] font-medium shadow-md shadow-indigo-600/10"
            >
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 shadow-xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[var(--color-border)] pb-4">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 bg-rose-600 hover:bg-rose-500 active:scale-98 transition-all rounded-xl text-[var(--color-text)] text-sm font-semibold shadow-md shadow-rose-600/15"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-3 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-2xl p-3 min-w-0" title={formatCurrency(montoApertura)}>
              <div className="w-9 h-9 rounded-xl bg-slate-500/10 flex items-center justify-center text-[var(--color-text-muted)]/80 shrink-0">
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 shadow-xl max-w-2xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <button
              ...
              className="flex-1 py-3 bg-emerald-600 hover:bg-emerald-500 active:scale-98 transition-all rounded-xl text-[var(--color-text)] font-medium flex items-center justify-center gap-2"
            >
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl w-full max-w-md p-6 shadow-2xl space-y-4">
            ...
            <form onSubmit={handleAddTransaction} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2 bg-indigo-600 text-[var(--color-text)] rounded-xl text-sm font-semibold hover:bg-indigo-500 transition-all"
                >
                  Registrar
                </button>
              </div>
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl w-full max-w-lg p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleConfirmCloseShift} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2 bg-rose-600 text-[var(--color-text)] rounded-xl text-sm font-semibold hover:bg-rose-500 active:scale-98 transition-all shadow-md shadow-rose-600/15"
                >
                  Confirmar y Cerrar
                </button>
              </div>
