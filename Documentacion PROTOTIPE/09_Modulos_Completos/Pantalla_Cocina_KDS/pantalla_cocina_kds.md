      ...
      <div className="flex justify-between items-center bg-[var(--color-surface-2)]/60 border border-[var(--color-border)] rounded-2xl p-4">
        <div>
          ...
          <p className="text-[10px] text-[var(--color-text-muted)]">
            Total de comandas activas: <span className="font-bold text-[var(--color-text)]">{orders.length}</span>
          </p>
        </div>
                      ...
                      <div className="pt-2">
                        {order.status === 'pending' && (
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-1.5 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-[var(--color-text)] rounded-xl text-[10px] font-bold transition-colors cursor-pointer"
                          >
                            <Play size={11} />
                            Iniciar Preparación
                          </button>
                        ...
                        {order.status === 'preparing' && (
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-1.5 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-[var(--color-text)] rounded-xl text-[10px] font-bold transition-colors cursor-pointer"
                          >
                            <Check size={11} />
                            Marcar como Listo
                          </button>
