<!--
{
  "resource": "TarjetasOperadoresAutorizados",
  "technicalName": "TarjetasOperadoresAutorizados",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/TarjetasOperadoresAutorizados.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Tarjetas de Operadores Autorizados

Catálogo responsivo en grid de operadores certificados de maquinaria pesada, mostrando licencias activas (A, B, C), experiencia e historial de seguridad.
...
export default function TarjetasOperadoresAutorizados() {
              ...
              >
                ...
                <div className="flex justify-between items-center pt-2.5 border-t border-[var(--color-border)]">
                  ...
                  <span className={'text-[10px] font-bold px-3 py-1.5 rounded-xl border transition-all ' + (
                    isSelected
                      ? 'bg-indigo-500 border-indigo-500 text-[var(--color-text)]'
