<!--
{
  "resource": "CalculadoraTarifasAlquiler",
  "technicalName": "CalculadoraTarifasAlquiler",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/CalculadoraTarifasAlquiler.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Calculadora de Tarifas de Alquiler

Panel de cotización de alquiler de maquinaria que desglosa tarifas por días, semanas o meses aplicando descuentos progresivos por volumen de tiempo.
...
export default function CalculadoraTarifasAlquiler() {
  ...
  const handleConfirmQuote = async () => {
    const confirm = await alertConfirm({
      ...
      message: '¿Deseas confirmar la cotización de alquiler por un total de 
```
 + calculated.total.toLocaleString() + ' COP?',
      variant: 'warning'
    });
