<!--
{
  "resource": "ChecklistInspeccionMaquinaria",
  "technicalName": "ChecklistInspeccionMaquinaria",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/ChecklistInspeccionMaquinaria.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Checklist de Inspección de Maquinaria

Formulario digital interactivo para control de entrega y recepción de maquinaria pesada, registrando niveles de fluidos, horómetro e incidencias visuales.
...
export default function ChecklistInspeccionMaquinaria() {
