<!--
{
  ...
  "targetPath": "src/components/common/SelectorAlquilerAndamios.jsx",
  "dependencies": {
    "npm": {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 flex flex-col gap-5">
              ...
              {accesorios.map(acc => (
                ...
                >
                  ...
                  <div className={`w-4 h-4 rounded border flex items-center justify-center ${
                    acc.checked ? 'bg-[var(--color-primary)] border-transparent text-[var(--color-text)]' : 'border-[var(--color-border)]'
                  }`}>
          ...
          >
            ...
            <div className={`w-4 h-4 rounded border flex items-center justify-center ${
              envioRequerido ? 'bg-emerald-500 border-transparent text-[var(--color-text)]' : 'border-[var(--color-border)]'
            }`}>
