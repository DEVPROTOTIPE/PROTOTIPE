        ...
        <>
          ...
          <div className="bg-surface rounded-2xl border border-app p-5 space-y-4">
            ...
            <button
              ...
              className="h-11 px-5 rounded-xl font-bold text-sm transition-all active:scale-95 flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-[var(--color-text)] cursor-pointer shadow-sm border-none"
            >
              <Receipt size={16} />
          ...
          <div className="bg-surface rounded-2xl border border-app p-5 space-y-4">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center gap-3">
              <button
                ...
                disabled={loading}
                className="w-full sm:w-auto px-6 min-h-11 py-2.5 bg-rose-500 text-[var(--color-text)] rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-rose-600 active:scale-95 disabled:opacity-50 transition-all cursor-pointer shadow-sm border-none text-center"
              >
                {loading ? (
              ...
              <button
                ...
                disabled={loading}
                className="w-full sm:w-auto px-6 min-h-11 py-2.5 bg-primary text-[var(--color-text)] rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 disabled:opacity-50 transition-all cursor-pointer shadow-sm border-none text-center"
              >
                {loading ? (
                  <Loader2 size={16} className="animate-spin shrink-0" />
                ) : (
                ...
                >
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 h-11 rounded-xl font-bold text-xs bg-emerald-500 hover:bg-emerald-600 text-[var(--color-text)] active:scale-95 transition-all cursor-pointer border-none"
                    >
                      Generar PDF
                    </button>
                  </div>
