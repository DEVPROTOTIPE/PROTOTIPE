<!--
{
  "resource": "CalculadoraMueblesMedida",
  "technicalName": "CalculadoraMueblesMedida",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/CalculadoraMueblesMedida.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Calculadora de Muebles a Medida

Formulario paramétrico interactivo para cotizar muebles ingresando ancho, alto y profundidad (mm), calculando en tiempo real placas de madera y costo total.
...
export default function CalculadoraMueblesMedida() {
  ...
  const handleConfirm = async () => {
    const confirm = await alertConfirm({
      ...
      message: '¿Añadir mueble a la lista por un valor estimado de 
```
