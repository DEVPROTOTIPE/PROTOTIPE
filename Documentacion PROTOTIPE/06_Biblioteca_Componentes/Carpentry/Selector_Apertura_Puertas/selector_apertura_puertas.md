<!--
{
  "resource": "SelectorAperturaPuertas",
  "technicalName": "SelectorAperturaPuertas",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/SelectorAperturaPuertas.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Selector de Apertura de Puertas

Selector gráfico de sentido de apertura de puertas y cajoneras (batiente izquierda/derecha, abatible aventos, corrediza) con visualización de limitantes de espacio.
...
export default function SelectorAperturaPuertas() {
