<!--
{
  "resource": "SelectorHerrajesAccesorios",
  "technicalName": "SelectorHerrajesAccesorios",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/SelectorHerrajesAccesorios.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Selector de Herrajes y Accesorios

Panel de control de herrajes para muebles (bisagras, correderas slow-closing, jaladeras de cajón) que calcula el impacto financiero en el costo de ensamble.
...
export default function SelectorHerrajesAccesorios() {
              ...
              >
                ...
                <div className="flex flex-col items-end gap-1.5 shrink-0">
                  ...
                  <div className={'w-4 h-4 rounded border flex items-center justify-center transition-colors ' + (
                    active ? 'bg-indigo-500 border-indigo-500 text-[var(--color-text)]' : 'border-[var(--color-border)] bg-[var(--color-surface-2)]'
                  )}>
