...
const defaultTheme = {
  ...
  searchBtn: "h-11 px-4 bg-primary text-white rounded-xl text-xs font-bold transition-all active:scale-95 shadow-sm hover:opacity-90 disabled:opacity-50 cursor-pointer flex items-center justify-center gap-1.5 shrink-0",
