    ...
    <>
      ...
      >
        ...
        <button
          type="button"
          onClick={toggleMenu}
          className={`absolute inset-0 flex items-center justify-center rounded-2xl shadow-xl hover:shadow-indigo-500/25 border border-[var(--color-border)] cursor-pointer text-[var(--color-text)] font-bold transition-all duration-300 hover:scale-105 active:scale-95 z-[992] ${
            isOpen
