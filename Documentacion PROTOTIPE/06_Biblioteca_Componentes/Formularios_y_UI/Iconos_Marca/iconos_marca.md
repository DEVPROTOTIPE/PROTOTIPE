<!--
{
  "technicalName": "BrandIcons",
  "targetPath": "src/components/ui/BrandIcons.jsx",
  "dependencies": {
    "npm": {},
    "internal": []
  }
...
# Hub de Iconos Atómicos de Marca (BrandIcons)

Este componente centraliza e implementa los logotipos e isotipos vectoriales oficiales de marcas comerciales y pasarelas de pago externas (`GitHub`, `WhatsApp`, `Google`, `Firebase`, `Stripe`, `DIAN`, `Visa`, `MasterCard`, `Apple`) requeridas en el ecosistema **PROTOTIPE**.

Al basarse en paths SVG oficiales y limpios con una grilla de **`viewBox="0 0 24 24"`** unificada para todas las marcas, se eliminan problemas de desalineación, tamaños desiguales y fallos en el empaquetado de producción de Vite.

---

## 1. Propósito y Casos de Uso
- **Identidad de Terceros Unificada:** Los iconos se renderizan bajo una proporción física idéntica, permitiendo grids y listas alineadas.
- **Resiliencia de Compilación:** Independiza al monorepo de paquetes de iconos de marcas ausentes.
- **Branding Híbrido:** Los iconos monocromáticos (`GitHub`, `WhatsApp`, `Stripe`, `Apple`) heredan las clases de texto y hover de Tailwind via `fill-current`. Los iconos multicolores (`Google`, `Firebase`, `DIAN`, `Visa`, `MasterCard`) se dibujan con sus colores de identidad corporativa sólidos.

---

## 2. Código React Completo y Portable (`BrandIcons.jsx`)
...
## 3. Guía de Uso e Integración

### Importación Recomendada:
```jsx
import { GithubIcon, WhatsappIcon, StripeIcon } from '@/components/ui/BrandIcons'
```
