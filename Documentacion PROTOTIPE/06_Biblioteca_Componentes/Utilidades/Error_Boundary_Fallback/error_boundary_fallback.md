        ...
        <div className="w-full p-6 bg-[var(--color-surface)]/30 border border-[var(--color-border)] rounded-3xl backdrop-blur-md flex flex-col md:flex-row gap-5 items-start justify-between">
          ...
          <div className="flex flex-row md:flex-col gap-2 w-full md:w-auto shrink-0 pt-1">
            <button
              ...
              className="flex-1 md:flex-initial px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 active:scale-95 text-[10px] font-black text-[var(--color-text)] flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-md shadow-indigo-600/10"
            >
              <RefreshCcw size={12} />
              Reintentar
            </button>
