<!--
{
  ...
  "targetPath": "src/components/common/ReporteControlCalidad.jsx",
  "dependencies": {
    "npm": {
    ...
    <div className="w-full max-w-xl mx-auto bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-5 shadow-sm">
      ...
      <div className="flex gap-1.5 mb-3">
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
            filter === 'approved'
              ? 'bg-green-600 border-green-600 text-[var(--color-text)]'
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[10px] font-bold border transition-colors cursor-pointer ${
            filter === 'rejected'
              ? 'bg-red-600 border-red-600 text-[var(--color-text)]'
