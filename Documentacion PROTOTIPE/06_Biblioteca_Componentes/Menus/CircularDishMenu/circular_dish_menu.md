  ...
  return (
    <div className={`space-y-6 select-none ${className}`}>
      ...
      >
        <button
          onClick={handlePrev}
          className="absolute left-4 z-30 p-2.5 rounded-full bg-[var(--color-surface)] border border-[var(--color-border)] shadow-lg shadow-[var(--color-shadow)] text-[var(--color-text)] hover:scale-105 active:scale-95 transition-all cursor-pointer"
        >
          <ChevronLeft size={18} />
        </button>
            ...
            return (
              ...
              >
                <div className="relative w-full h-full flex items-center justify-center">
                      ...
                      <div className="w-full h-full rounded-full overflow-hidden bg-[var(--color-surface-2)] border border-[var(--color-border)] relative flex items-center justify-center">
                        ...
                        {!item.available && (
                          <div className="absolute inset-0 bg-black/60 backdrop-blur-[1px] flex items-center justify-center rounded-full">
                            <span className="text-[8px] sm:text-[9px] font-black uppercase text-[var(--color-text)] tracking-widest px-1.5 py-0.5 bg-red-600 rounded">Agotado</span>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  {item.badge && (
                    <span className={`absolute -top-1 -right-1 bg-[var(--color-primary)] text-[var(--color-text)] font-black uppercase tracking-wider rounded-full shadow-md text-[8px] sm:text-[9px] z-10 ${
        ...
        <button
          onClick={handleNext}
          className="absolute right-4 z-30 p-2.5 rounded-full bg-[var(--color-surface)] border border-[var(--color-border)] shadow-lg shadow-[var(--color-shadow)] text-[var(--color-text)] hover:scale-105 active:scale-95 transition-all cursor-pointer"
        >
          ...
          <div className="flex flex-col md:flex-row gap-5 items-start md:items-center">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {activeDish.badge && (
                  <span className="text-[8px] font-black uppercase tracking-wider px-2 py-0.5 bg-[var(--color-primary)] text-[var(--color-text)] rounded-lg">
                    {activeDish.badge}
                  </span>
                )}
              </div>
