      ...
      <div className={`bg-[var(--color-surface, #ffffff)] border border-[var(--color-border, rgba(229, 229, 229, 0.3))] rounded-3xl p-7 max-w-sm w-full shadow-2xl animate-fade-in-up text-left`}>
        ...
        <div className="flex gap-2.5">
          ...
          <button
            ...
            className={`flex-1 py-2.5 ${v.bg} focus:outline-none focus:ring-2 ${v.ring} text-[var(--color-text)] text-xs font-bold rounded-xl cursor-pointer transition-all active:scale-95`}
          >
            {v.label}
          </button>
        </div>
