    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_200px] gap-6 items-center">
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-4 items-center overflow-x-auto pb-2 scrollbar-thin">
          ...
          >
            <div className="absolute top-2.5 left-2.5 bg-indigo-650 text-[9px] font-black text-[var(--color-text)] px-2 py-0.5 rounded-lg shadow-md uppercase">
              Base
            </div>
            <img 
                  ...
                  return (
                    <button
                      ...
                      className={`px-2 py-0.5 rounded-lg text-[9px] font-bold border transition-all cursor-pointer ${
                        isSelected 
                          ? 'bg-indigo-600 border-indigo-600 text-[var(--color-text)] shadow-sm shadow-indigo-600/10'
              ...
              >
                <div className="relative">
                  ...
                  <div className={`absolute -top-1.5 -left-1.5 w-4.5 h-4.5 rounded-full border flex items-center justify-center transition-all ${
                    isSelected ? 'bg-indigo-600 border-indigo-600 text-[var(--color-text)]' : 'bg-[var(--color-surface-2)] border-[var(--color-border)]'
                  }`}>
                    {isSelected && (
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left bg-[var(--color-surface-2)]/30 p-4 rounded-2xl border border-[var(--color-border)]">
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-550 !text-[var(--color-text)] text-xs font-bold py-2.5 px-3 rounded-xl shadow-lg shadow-indigo-600/10 active:scale-98 transition-all cursor-pointer"
          >
