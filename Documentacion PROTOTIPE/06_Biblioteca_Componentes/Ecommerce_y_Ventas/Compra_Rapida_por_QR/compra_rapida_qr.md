...
export function QRProductPublicDetail({
      ...
      <div className="min-h-screen bg-app flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="flex flex-col gap-3 w-full max-w-xs">
          <button
            ...
            className="h-12 px-6 bg-primary text-[var(--color-text)] font-bold text-sm rounded-2xl active:scale-95 transition-all shadow-md shadow-primary/20 border-none cursor-pointer"
          >
  ...
  return (
    <div className="min-h-screen bg-app pb-32 relative">
      ...
      <main className="max-w-md mx-auto pt-24 px-4">
        ...
        <div className="relative w-full aspect-square bg-surface rounded-3xl overflow-hidden border border-app shadow-sm">
          ...
          {isFullyOutOfStock && (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-black/60 backdrop-blur-sm px-5 py-2.5 rounded-full flex items-center gap-2">
                ...
                <span className="text-[var(--color-text)] font-black text-xs uppercase tracking-widest">Temporalmente agotado</span>
              </div>
            </div>
          )}
          ...
          {product.tienePromocion && !isFullyOutOfStock && (
            <div className="absolute top-4 left-4 py-1.5 px-3 rounded-full bg-primary text-[var(--color-text)] font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5 shadow-lg shadow-primary/20">
              ...
              {tallas.map(t => (
                <button
                  ...
                  className={`h-10 px-4 rounded-xl text-sm font-semibold transition-all border-2 active:scale-95 cursor-pointer ${
                    selectedTalla === t 
                      ? 'border-primary bg-primary text-[var(--color-text)]' 
        ...
        {isFullyOutOfStock ? (
          <div className="max-w-md mx-auto w-full space-y-3">
            ...
            <button
              ...
              className="w-full h-14 rounded-2xl font-bold text-sm uppercase tracking-wider text-[var(--color-text)] hover:opacity-90 active:scale-95 transition-all duration-300 flex items-center justify-center gap-2.5 shadow-lg cursor-pointer border-none"
          ...
          <>
            ...
            <div className="flex gap-3 max-w-md mx-auto w-full">
              ...
              <button
                ...
                className="flex-1 h-14 rounded-2xl font-bold text-sm uppercase tracking-wider bg-primary text-[var(--color-text)] hover:opacity-90 shadow-lg shadow-primary/20 active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer border-none"
              >
      ...
      {showToast && (
        <div className="fixed bottom-24 left-1/2 -translate-x-1/2 px-5 py-3.5 rounded-2xl shadow-2xl border border-green-500/20 bg-green-500 text-[var(--color-text)] flex items-center gap-3 z-[100] text-sm font-extrabold w-[90%] max-w-sm">
