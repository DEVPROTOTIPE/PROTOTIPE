                ...
                <div className="flex gap-2.5 pt-2 border-t border-[var(--color-border)]/20 mt-1">
                  ...
                  {isClickAndCollectAvailable && onSelectStore && (
                    <button
                      ...
                      className="flex-1 bg-indigo-650 hover:bg-indigo-550 !text-[var(--color-text)] text-[11px] font-bold py-2 px-3 rounded-xl shadow-lg shadow-indigo-650/10 active:scale-98 transition-all cursor-pointer"
                    >
                      Retirar en local
                    </button>
                  )}
