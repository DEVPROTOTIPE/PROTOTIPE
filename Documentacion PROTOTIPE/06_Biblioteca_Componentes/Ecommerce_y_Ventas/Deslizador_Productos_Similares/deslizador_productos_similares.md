      ...
      <div className="flex justify-between items-center mb-4 px-1">
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={() => scroll('left')}
            className="w-7 h-7 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-2)] text-[var(--color-text)] flex items-center justify-center hover:bg-indigo-600 hover:text-[var(--color-text)] transition-all duration-300 cursor-pointer shadow-sm"
          >
          ...
          >
            <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-[var(--color-surface-2)] mb-3">
              ...
              <div className="absolute inset-0 bg-[var(--color-bg)]/20 opacity-0 group-hover/card:opacity-100 transition-opacity flex items-center justify-center">
                <span className="bg-indigo-600 !text-[var(--color-text)] text-[10px] font-bold py-1.5 px-3 rounded-lg shadow-lg shadow-indigo-650/15 scale-90 group-hover/card:scale-100 transition-all duration-300">
                  Ver detalle
                </span>
              </div>
            </div>
