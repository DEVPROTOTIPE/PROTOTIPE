<!--
{
  ...
  "targetPath": "src/features/diagnostics/services/errorDiagnosticsService.js",
  "dependencies": {
    "npm": {},
    "internal": []
  }
...
export default function ErrorDiagnosticConsole({ 
  ...
  return (
    <div className="space-y-6 animate-fade-in relative">
      {/* Toast Local */}
      {toastMessage && (
        <div className="fixed bottom-4 right-4 z-50 bg-indigo-600 text-[var(--color-text)] px-4 py-2.5 rounded-xl text-xs font-bold shadow-lg animate-scale-up flex items-center gap-2 border border-indigo-500/25">
          <CheckCircle size={14} />
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                    ...
                    <div className="space-y-1 flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="px-2 py-0.5 bg-[var(--color-surface-1)] text-[var(--color-text-muted)] font-mono text-[9px] font-black rounded uppercase">
                          {fail.clientId}
                        </span>
                    ...
                    <div className="flex items-center gap-2 shrink-0 self-end sm:self-start">
                      ...
                      {!fail.resolved && (
                        <button 
                          ...
                          className="px-2.5 py-1 bg-emerald-600 hover:bg-emerald-500 text-[var(--color-text)] text-[10px] font-bold rounded-lg transition-colors cursor-pointer active:scale-95 shadow"
                        >
                          Resolver
                        </button>
                      )}
                  ...
                  {isExpanded && (
                    <div className="mt-3.5 space-y-1.5 animate-fade-in">
                      ...
                      <pre className="bg-[var(--color-surface-3)] font-mono text-[10px] p-3.5 rounded-xl border border-red-500/15 overflow-x-auto text-red-300 leading-relaxed shadow-inner select-text select-all">
                        {fail.stack}
                      </pre>
                    </div>
                  )}
            ...
            <div className="w-screen max-w-md bg-[var(--color-surface)] border-l border-[var(--color-border)] shadow-2xl flex flex-col justify-between select-text animate-slide-in-right">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-1 gap-2.5">
                        <button
                          ...
                          className="w-full py-2.5 bg-violet-600 hover:bg-violet-500 text-[var(--color-text)] font-extrabold text-xs rounded-xl shadow-sm hover:shadow transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]"
                        >
                          <Copy size={13} />
                        ...
                        >
                          <Database size={12} className="text-[var(--color-text-muted)]/80" />
                ...
                <div className="space-y-2">
                  ...
                  <pre className="bg-[var(--color-surface-3)] font-mono text-[9px] p-4 rounded-2xl border border-[var(--color-border)] overflow-x-auto text-red-350/90 leading-relaxed shadow-inner select-text select-all">
              ...
              <div className="p-6 border-t border-[var(--color-border)] bg-[var(--color-surface-2)]/30 flex items-center justify-between gap-3">
                ...
                {!selectedDiagnosticError.resolved && (
                  <button
                    ...
                    className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-[var(--color-text)] text-xs font-bold rounded-xl transition-all cursor-pointer active:scale-95 shadow"
                  >
                    Resolver Incidente
                  </button>
                )}
