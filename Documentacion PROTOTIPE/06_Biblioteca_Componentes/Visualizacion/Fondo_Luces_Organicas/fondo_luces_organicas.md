  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="absolute w-80 h-80 sm:w-[450px] sm:h-[450px] rounded-full blur-[90px] sm:blur-[130px] opacity-25 sm:opacity-30 pointer-events-none will-change-transform top-[-10%] left-[5%]"
      />
      ...
      <div 
        ...
        className="absolute w-80 h-80 sm:w-[500px] sm:h-[500px] rounded-full blur-[90px] sm:blur-[140px] opacity-20 sm:opacity-25 pointer-events-none will-change-transform bottom-[-10%] right-[10%]"
      />
      ...
      <div 
        ...
        className="absolute w-64 h-64 sm:w-[380px] sm:h-[380px] rounded-full blur-[80px] sm:blur-[120px] opacity-15 sm:opacity-20 pointer-events-none will-change-transform top-[30%] left-[40%]"
      />
