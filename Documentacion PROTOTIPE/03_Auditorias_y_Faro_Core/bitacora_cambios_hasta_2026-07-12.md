...
## BUG-405: Corrección de Sincronización del Core, Escaneo de Subcarpetas en Windows y Purga de Instancias de Prueba
- **Fecha:** 2026-07-12
...
- **Archivos afectados:** - ``Prototipe-CLI/sync_templates.js`` [MODIFY]
