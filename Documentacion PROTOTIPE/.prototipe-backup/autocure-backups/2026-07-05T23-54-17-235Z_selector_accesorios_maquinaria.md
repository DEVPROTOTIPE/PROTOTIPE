<!--
{
  "resource": "SelectorAccesoriosMaquinaria",
  "technicalName": "SelectorAccesoriosMaquinaria",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/SelectorAccesoriosMaquinaria.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Selector de Accesorios de Maquinaria

Panel de selection de acoples y aditamentos compatibles para retroexcavadoras o minicargadores (baldes, martillos, zanjadoras) con cálculo de incremento tarifario.
...
export default function SelectorAccesoriosMaquinaria() {
  ...
  const handleConfirm = async () => {
    ...
    const confirm = await alertConfirm({
      ...
      message: '¿Deseas añadir los accesorios seleccionados por un recargo de 
```
 + totalAdicional.toLocaleString() + ' COP/día?',
      variant: 'warning'
    });
