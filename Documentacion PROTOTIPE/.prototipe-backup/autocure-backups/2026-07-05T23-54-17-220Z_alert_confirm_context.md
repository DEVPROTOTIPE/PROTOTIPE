<!--
{
  ...
  "targetPath": "src/features/common/hooks/useAlertConfirm.js",
  "dependencies": {
    "npm": {},
    "internal": []
  }
    ...
    <AlertConfirmContext.Provider value={{ showAlert, showConfirm }}>
      ...
      <ModalTemplate isOpen={modalState.isOpen} onClose={() => handleClose(false)} title={null}>
        <div className="text-center py-2">
          {getHeaderIcon()}
          <h3 className="text-lg font-bold text-gray-900 dark:text-[var(--color-text)] mb-2">{modalState.title}</h3>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button
              ...
              className={`flex-1 py-3 px-4 text-[var(--color-text)] font-bold text-sm transition-all active:scale-95 cursor-pointer ${
