<!--
{
  "resource": "TablaDespieceMateriales",
  "technicalName": "TablaDespieceMateriales",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/TablaDespieceMateriales.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
Listado interactivo que desglosa piezas de madera a cortar, detallando longitud, anchura, orientación de la veta y cantos de PVC requeridos.
...
export default function TablaDespieceMateriales() {
