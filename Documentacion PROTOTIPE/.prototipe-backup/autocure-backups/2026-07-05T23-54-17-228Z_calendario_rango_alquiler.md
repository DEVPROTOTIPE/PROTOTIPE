<!--
{
  "resource": "CalendarioRangoAlquiler",
  "technicalName": "CalendarioRangoAlquiler",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/CalendarioRangoAlquiler.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Calendario de Rango de Alquiler

Calendario interactivo de selección de rango de fechas para reservar maquinaria pesada con visualización en caliente de disponibilidad y tarifas estacionales.
...
export default function CalendarioRangoAlquiler() {
