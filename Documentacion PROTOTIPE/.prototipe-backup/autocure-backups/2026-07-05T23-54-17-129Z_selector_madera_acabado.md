<!--
{
  "resource": "SelectorMaderaAcabado",
  "technicalName": "SelectorMaderaAcabado",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/SelectorMaderaAcabado.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Selector de Madera y Acabado

Muestrario digital interactivo de tipos de maderas, melaminas y acabados de laca o tinte con visualización de compatibilidades y usos recomendados.
...
export default function SelectorMaderaAcabado() {
              ...
              return (
                ...
                >
                  ...
                  <div className={'w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ' + (
                    active ? 'border-indigo-500 bg-indigo-500 text-[var(--color-text)]' : 'border-[var(--color-border)] bg-[var(--color-surface-2)]'
                  )}>
