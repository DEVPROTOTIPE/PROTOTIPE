<!--
{
  "resource": "OptimizadorCorteTableros",
  "technicalName": "OptimizadorCorteTableros",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/OptimizadorCorteTableros.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
Algoritmo visual interactivo de distribución y optimización de cortes en tableros de madera estándar para maximizar el uso y calcular el porcentaje de desperdicio (merma).
...
export default function OptimizadorCorteTableros() {
