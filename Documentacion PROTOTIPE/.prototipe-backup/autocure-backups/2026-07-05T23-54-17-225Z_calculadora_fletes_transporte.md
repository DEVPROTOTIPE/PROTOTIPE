<!--
{
  "resource": "CalculadoraFletesTransporte",
  "technicalName": "CalculadoraFletesTransporte",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/CalculadoraFletesTransporte.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Calculadora de Fletes y Transporte

Cotizador logístico de traslados de maquinaria que estima costos de fletes ingresando distancia (km), peso del equipo y tipo de camión cama-baja.
...
export default function CalculadoraFletesTransporte() {
  ...
  const handleConfirmQuote = async () => {
    const confirm = await alertConfirm({
      ...
      message: '¿Confirmar costo de movilización por un total de 
```
