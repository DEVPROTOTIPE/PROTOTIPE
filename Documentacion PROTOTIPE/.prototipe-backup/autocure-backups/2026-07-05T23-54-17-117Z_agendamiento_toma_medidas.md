<!--
{
  "resource": "AgendamientoTomaMedidas",
  "technicalName": "AgendamientoTomaMedidas",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/AgendamientoTomaMedidas.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Agendamiento de Toma de Medidas

Formulario de agenda premium interactivo para coordinar visitas técnicas de rectificación de medidas en el domicilio del cliente sin pickers nativos.
...
export default function AgendamientoTomaMedidas() {
