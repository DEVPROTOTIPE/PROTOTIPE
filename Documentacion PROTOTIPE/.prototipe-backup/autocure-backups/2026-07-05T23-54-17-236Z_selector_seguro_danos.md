<!--
{
  "resource": "SelectorSeguroDanos",
  "technicalName": "SelectorSeguroDanos",
  "type": "component",
  "niches": [
    "machinery_rental"
  ],
  "targetPath": "src/components/common/SelectorSeguroDanos.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Selector de Seguro contra Daños

Comparador y selector de pólizas de seguro contra accidents para alquiler de maquinaria pesada, detallando coberturas, deducibles y exención de cargos.
...
export default function SelectorSeguroDanos() {
