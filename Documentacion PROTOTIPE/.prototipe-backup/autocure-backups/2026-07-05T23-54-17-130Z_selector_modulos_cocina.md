<!--
{
  "resource": "SelectorModulosCocina",
  "technicalName": "SelectorModulosCocina",
  "type": "component",
  "niches": [
    "carpentry"
  ],
  "targetPath": "src/components/common/SelectorModulosCocina.jsx",
  "dependencies": {
    "npm": {},
    "internal": [
      {
...
# Selector de Módulos de Cocina

Asistente gráfico interactivo para presupuestar cocinas modulares, arrastrando y acoplando módulos superiores, inferiores, despensas y esquineros.
...
export default function SelectorModulosCocina() {
