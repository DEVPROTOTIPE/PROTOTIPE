...
/**
 * DeveloperBillingPanel — Panel de facturación del desarrollador.
 * Muestra comisiones y modelos de cobro de forma centralizada.
 */
export default function DeveloperBillingPanel({ config, setSaveMessage }) {
  ...
  const handleExportDeveloperReceiptPDF = async () => {
    try {
      ...
      // PDF export imports dynamically
      const { exportDeveloperReceiptPDF } = await import('../../../../services/pdfService')
      // No orders available in core seed, passing empty array
        ...
        <>
          ...
          <div className="bg-surface rounded-2xl border border-app p-5 space-y-4">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center gap-3">
              ...
              >
                {loading ? (
                  <Loader2 size={16} className="animate-spin shrink-0 animate-all" />
                ) : (
                  <AlertTriangle size={16} className="shrink-0 animate-all" />
                )}
              ...
              >
                {loading ? (
                  ...
                  <Activity size={16} className="shrink-0 animate-all" />
                )}
