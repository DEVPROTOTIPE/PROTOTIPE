    ...
    <AnimatePresence>
      {isInstallable && (
        <motion.div
          ...
          className="fixed bottom-6 left-4 right-4 md:left-auto md:right-6 md:w-full md:max-w-[22.5rem] z-50 p-4 rounded-3xl bg-surface/85 backdrop-blur-lg border border-app shadow-2xl flex flex-col gap-4"
        >
          {/* Fila de Encabezado */}
