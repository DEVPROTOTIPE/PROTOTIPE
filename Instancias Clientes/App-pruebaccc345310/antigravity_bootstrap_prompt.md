# 🚀 Prompt de Arranque para Google Antigravity (Proyecto: PRUEBACCC345310)

Copia y pega todo el contenido de este bloque en tu primer mensaje del chat de Antigravity en este proyecto:

---

Hola. Vamos a trabajar sobre este nuevo proyecto: **PRUEBACCC345310** (pruebaccc345310). 
La carpeta física está creada en la ruta: `D:\PROTOTIPE\Instancias Clientes\App-pruebaccc345310`
...
1. **Mapa de Código de este Proyecto** → [mapa_arquitectura_ia.md](file:///D:/PROTOTIPE/Instancias Clientes/App-pruebaccc345310/mapa_arquitectura_ia.md): contiene la estructura física de todos los archivos y carpetas locales.
...
3. **Instrucciones del Proyecto** → [GEMINI.md](file:///D:/PROTOTIPE/Instancias Clientes/App-pruebaccc345310/GEMINI.md): reglas de comportamiento, estándares del stack y disparadores locales.
...
5. **Documentación Obligatoria del Proyecto (Carpeta Local):**
   - 🏢 **[contexto_negocio.md](file:///D:/PROTOTIPE/Instancias Clientes/App-pruebaccc345310/Documentacion%20PRUEBACCC345310/contexto_negocio.md)**: Lee esto PRIMERO — define quién es el cliente, sus reglas de negocio y KPIs. Determina si el código que generas tiene sentido operativo.
   - 🚫 **[restricciones_tecnicas.md](file:///D:/PROTOTIPE/Instancias Clientes/App-pruebaccc345310/Documentacion%20PRUEBACCC345310/restricciones_tecnicas.md)**: Dependencias fijadas, patrones prohibidos y limitaciones conocidas de esta instancia. Consulta antes de instalar librerías o cambiar arquitectura.
   - 🎨 **[guia_estilos_ui.md](file:///D:/PROTOTIPE/Instancias Clientes/App-pruebaccc345310/Documentacion%20PRUEBACCC345310/guia_estilos_ui.md)**: Paleta HSL, tokens de diseño y convenciones de componentes. Obligatorio antes de tocar cualquier estilo.
   - 🗄️ **[esquema_colecciones.md](file:///D:/PROTOTIPE/Instancias Clientes/App-pruebaccc345310/Documentacion%20PRUEBACCC345310/esquema_colecciones.md)**: Modelo de datos Firestore de esta instancia.
...
- **Nombre**: PRUEBACCC345310
- **Client ID**: pruebaccc345310
