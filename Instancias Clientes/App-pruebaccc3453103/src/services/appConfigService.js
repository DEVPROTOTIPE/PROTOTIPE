...
export const DEFAULT_SETTINGS = {
  ...
  sellerName: 'Vendedor',
  appIcon: '',
  theme: import.meta.env.VITE_INITIAL_THEME || 'zafiro-moderno',
  whatsappAdmin: import.meta.env.VITE_DEVELOPER_WHATSAPP_ADMIN || '',
  ...
  // ─── Apariencia avanzada ───────────────────────────────────────────
  appFont: import.meta.env.VITE_INITIAL_FONT || 'inter',
  appRadius: import.meta.env.VITE_INITIAL_RADIUS || 'rounded',
  ...
  deliverySettings: {
    pickup: {
      enabled: true,
      address: import.meta.env.VITE_DEVELOPER_STORE_ADDRESS || '',
