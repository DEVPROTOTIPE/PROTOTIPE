...
/**
 * AppearanceSettings — Módulo modular de configuración visual para marcas.
 * Permite cambiar paletas, modo oscuro, tipografías y redondez de bordes globales.
 */
export default function AppearanceSettings({ 
  ...
  // Bloquear scroll del body al abrir el modal de temas
  useEffect(() => {
      ...
      <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app">
        <div className="p-5 sm:p-6 flex flex-col gap-5">
          ...
          <div className="p-4 bg-surface-2 rounded-2xl border border-app">
            ...
            <p className="text-xs text-muted mb-3">Redondez global de contenedores y botones</p>
        ...
        <div className="p-5 sm:p-6 border-t border-app bg-surface-2/30">
          <button onClick={handleSaveConfig} disabled={isSaving}
            className="w-full min-h-[52px] py-3 px-6 bg-primary text-white rounded-xl font-bold text-sm transition-all duration-300 active:scale-95 hover:opacity-90 flex items-center justify-center gap-3 shadow-lg shadow-primary/30 disabled:opacity-50 cursor-pointer border-none">
