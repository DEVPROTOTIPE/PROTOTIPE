...
Este documento detalla la estructura lógica, el propósito y la justificación técnica de las colecciones de Firestore necesarias para la operación y contabilidad del sistema **Test App Sinc**.
