...
import { useProduct, useCategories } from '../../features/inventory'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <div className="space-y-4">
            ...
            <div 
              ...
              className={`relative w-full aspect-square bg-surface-2 rounded-2xl overflow-hidden shadow-sm hover:shadow-[0_20px_50px_rgba(0,0,0,0.14)] dark:hover:shadow-[0_20px_50px_rgba(0,0,0,0.35)] shrink-0 border border-neutral-200/80 dark:border-neutral-800/80 group cursor-crosshair transition-shadow duration-500 ${
            ...
            >
              ...
              {activeImages.length > 0 ? (
                <>
                  ...
                  <div className={`absolute inset-0 pointer-events-none rounded-2xl overflow-hidden transition-opacity duration-200 shadow-[inset_0_0_20px_rgba(0,0,0,0.06)] z-15 ${
                  ...
                  <div 
                    className={`absolute inset-0 pointer-events-none rounded-2xl overflow-hidden transition-opacity duration-300 z-16 ${
                      isMobileZoomActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                    }`}
                    style={{
          ...
          <div className="space-y-4 px-1 md:px-0">
            ...
            {currentVariant && currentVariant.stock > 0 && currentVariant.stock <= (commercialOptimization?.tools?.smartTags?.lastUnit?.threshold || 3) && (
              <div className="flex">
                <span className="inline-flex items-center gap-1.5 bg-[var(--color-primary)] text-white text-[10px] font-black uppercase px-2.5 py-1 rounded-xl shadow-sm border border-black/10">
