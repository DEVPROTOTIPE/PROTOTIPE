...
### [2026-07-10] - Despliegue de Reglas e Índices Firestore (App Moni)
* **Tipo:** Despliegue / Configuración / Seguridad
* **Severidad:** Alta
* **Descripción de Cambios:**
  - Desplegadas las reglas de seguridad (`firestore.rules`) en el proyecto Firebase `ventas-moni-app` para alinearlo con los últimos parches de seguridad (Notificaciones, Tracking, etc.).
  - Desplegados los índices compuestos (`firestore.indexes.json`) en el proyecto Firebase `ventas-moni-app`.
  - Validación: Ejecución exitosa de la prueba de integración de extremo a extremo (`checkout.spec.js`) con Playwright (1 test passed).
* **Archivos Modificados:**
  - Ninguno (acción de despliegue sobre Firebase de producción).
