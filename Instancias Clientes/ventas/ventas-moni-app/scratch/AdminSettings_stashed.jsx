...
export default function AdminSettings() {
  ...
  const MENU_SECTIONS = [
    ...
    },
    {
      ...
      description: 'Activa temas visuales especiales (Navidad, Halloween, Día de la Madre/Padre)',
      icon: Calendar,
    ...
    {
      id: 'laboratorio',
      label: 'Laboratorio de Innovación',
      description: 'Prueba funciones experimentales, IA y módulos industriales',
      icon: Sparkles,
      iconBg: 'bg-purple-500/10',
      iconColor: 'text-purple-500',
    },
  ...
  return (
    ...
    >
              ...
              ? (activeSubSection === 'empleados' 
                  ...
                  : activeSubSection === 'entregas' 
                    ...
                    : activeSubSection === 'temporada'
                      ...
                      : activeSubSection === 'mayorista'
                        ? 'Configura valores mínimos y cotizaciones de mayoreo'
                        : activeSubSection === 'garantias'
                          ? 'Administra políticas de cambios e inicios de reclamo'
                          : activeSubSection === 'seguimiento'
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app">
            <div className="bg-primary/5 px-5 py-3 border-b border-app">
              ...
              <p className="text-[10px] text-muted mt-0.5">Configuraciones básicas de identidad, contacto, apariencia y PWA.</p>
            </div>
          ...
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app">
            <div className="bg-emerald-500/5 px-5 py-3 border-b border-app">
              ...
              <p className="text-[10px] text-muted mt-0.5">Gestión operativa comercial, promociones, personal y eventos estacionales.</p>
            </div>
          ...
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app">
            <div className="bg-red-500/5 px-5 py-3 border-b border-app">
              ...
              <p className="text-[10px] text-muted mt-0.5">Zona de desarrollador: arquitectura, facturación y telemetría avanzada.</p>
            </div>
            {['developer'].map((id) => {
              const section = MENU_SECTIONS.find(s => s.id === id)
              if (!section) return null
          ...
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app">
            <div className="bg-purple-500/5 px-5 py-3 border-b border-app">
              ...
              <p className="text-[10px] text-muted mt-0.5">Espacio de innovación: accesos rápidos a portales especializados e industrias.</p>
            </div>
            {['laboratorio'].map((id) => {
              const section = MENU_SECTIONS.find(s => s.id === id)
              if (!section) return null
          ...
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app">
            <div className="bg-slate-500/5 px-5 py-3 border-b border-app">
              ...
              <p className="text-[10px] text-muted mt-0.5">Configuraciones técnicas internas de la cuenta y accesos de seguridad.</p>
            </div>
            {['seguridad'].map((id) => {
              const section = MENU_SECTIONS.find(s => s.id === id)
              if (!section) return null
      ...
      {activeSection === 'developer' && (
        !isDevAuthenticated ? (
          ...
          <div>
                  ...
                  {[
                    {
                      ...
                      description: 'Establece retiros en local, envíos a domicilio, costos y entregas digitales.',
                      icon: Truck,
                    ...
                    },
                    {
                      ...
                      description: 'Configura la cantidad mínima, el tipo de descuento y el valor de mayoreo.',
                      icon: Percent,
                    ...
                    },
                    {
                      ...
                      description: 'Permite a tus clientes seguir sus pedidos en tiempo real por WhatsApp sin iniciar sesión.',
                      icon: Package,
                    ...
                    },
                    {
                      ...
                      description: 'Configura y activa/desactiva los módulos globales del negocio (Crédito, Reclamos, Cupones, Mayoreo, Empleados, Descartes)',
                      icon: ToggleLeft,
            ...
            {/* 1.5. Subsección: Módulos Activos */}
            {activeSubSection === 'dev-modulos' && (
              <>
                <div className="bg-surface rounded-3xl shadow-sm overflow-hidden p-5 sm:p-6 space-y-5 border border-app">
                  ...
                  <div className="flex items-center justify-between p-4 bg-surface-2 rounded-2xl border border-app">
                    <div>
                      <p className="text-sm font-bold text-app">Módulo de Múltiples Empleados</p>
                      <p className="text-xs text-muted mt-0.5">Activa esta opción si tu negocio cuenta con personal de ventas o despachadores en el POS.</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                      <input type="checkbox" className="sr-only peer"
                  ...
                  <div className="flex items-center justify-between p-4 bg-surface-2 rounded-2xl border border-app">
                    <div>
                      <p className="text-sm font-bold text-app">Módulo de Ajustes de Inventario y Descartes</p>
                      <p className="text-xs text-muted mt-0.5">Permite registrar regalos, averías y consumos internos en el POS.</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                      <input type="checkbox" className="sr-only peer"
      ...
      {/* ─── VISTA: LABORATORIO DE INNOVACIÓN ─────────────────────────────────────── */}
      {activeSection === 'laboratorio' && (
        <div className="bg-surface rounded-3xl shadow-sm overflow-hidden border border-app p-6 space-y-6">
          <div className="flex items-center gap-3 border-b border-app pb-4">
            ...
            <div>
              <h2 className="text-base font-black text-app">Nivel 4: Laboratorio de Innovación</h2>
              <p className="text-xs text-muted mt-0.5">Zona exclusiva para probar prototipos y módulos por industria antes de su liberación oficial.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-5 rounded-2xl border border-app bg-surface-2 space-y-3 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2.5">
                  <p className="text-sm font-bold text-app">🍽️ Módulo Restaurante & Cocina</p>
                ...
                <p className="text-xs text-muted leading-relaxed mt-2">
                  Habilita el panel de turnero interactivo y cola de preparación de platos en tiempo real.
                </p>
              </div>
              <button 
                onClick={() => alert("Módulo Restaurante inicializado en pruebas de laboratorio.")}
            ...
            <div className="p-5 rounded-2xl border border-app bg-surface-2 space-y-3 opacity-60 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2.5">
                  <p className="text-sm font-bold text-app">💈 Barbería & Agendamiento</p>
                  <span className="px-2 py-0.5 bg-amber-500/10 text-amber-500 rounded-md text-[9px] font-bold uppercase tracking-wider">Próximamente</span>
                </div>
                <p className="text-xs text-muted leading-relaxed mt-2">
                  Agenda inteligente, turnos y asignación de barberos.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl border border-app bg-surface-2 space-y-3 opacity-60 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2.5">
                  <p className="text-sm font-bold text-app">🔧 Ferretería & Cotizaciones</p>
                  <span className="px-2 py-0.5 bg-amber-500/10 text-amber-500 rounded-md text-[9px] font-bold uppercase tracking-wider">Próximamente</span>
                </div>
                <p className="text-xs text-muted leading-relaxed mt-2">
                  Gestión de cotizaciones rápidas para proyectos y construcción.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-2xl border border-app bg-surface-2 space-y-3 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2.5">
                  <p className="text-sm font-bold text-app">🧠 Asistente Inteligente IA</p>
                ...
                <p className="text-xs text-muted leading-relaxed mt-2">
                  Generación automática de descripciones y variantes de productos con IA.
                </p>
              </div>
              <button 
