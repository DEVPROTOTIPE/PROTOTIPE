# 🚀 Prompt de Arranque para Google Antigravity (Proyecto: DSDSD1SD1S)

Copia y pega todo el contenido de este bloque en tu primer mensaje del chat de Antigravity en este proyecto:

---

Hola. Vamos a trabajar sobre este nuevo proyecto: **DSDSD1SD1S** (dsdsd1sd1s). 
La carpeta física está creada en la ruta: `D:\PROTOTIPE\Instancias Clientes\App-dsdsd1sd1s`
...
1. **Mapa de Código de este Proyecto** → [mapa_arquitectura_ia.md](file:///D:/PROTOTIPE/Instancias Clientes/App-dsdsd1sd1s/mapa_arquitectura_ia.md): contiene la estructura física de todos los archivos y carpetas locales.
...
3. **Instrucciones del Proyecto** → [GEMINI.md](file:///D:/PROTOTIPE/Instancias Clientes/App-dsdsd1sd1s/GEMINI.md): reglas de comportamiento, estándares del stack y disparadores locales.
...
5. **Documentación Obligatoria del Proyecto (Carpeta Local):**
   - 🏢 **[contexto_negocio.md](file:///D:/PROTOTIPE/Instancias Clientes/App-dsdsd1sd1s/Documentacion%20DSDSD1SD1S/contexto_negocio.md)**: Lee esto PRIMERO — define quién es el cliente, sus reglas de negocio y KPIs. Determina si el código que generas tiene sentido operativo.
   - 🚫 **[restricciones_tecnicas.md](file:///D:/PROTOTIPE/Instancias Clientes/App-dsdsd1sd1s/Documentacion%20DSDSD1SD1S/restricciones_tecnicas.md)**: Dependencias fijadas, patrones prohibidos y limitaciones conocidas de esta instancia. Consulta antes de instalar librerías o cambiar arquitectura.
   - 🎨 **[guia_estilos_ui.md](file:///D:/PROTOTIPE/Instancias Clientes/App-dsdsd1sd1s/Documentacion%20DSDSD1SD1S/guia_estilos_ui.md)**: Paleta HSL, tokens de diseño y convenciones de componentes. Obligatorio antes de tocar cualquier estilo.
   - 🗄️ **[esquema_colecciones.md](file:///D:/PROTOTIPE/Instancias Clientes/App-dsdsd1sd1s/Documentacion%20DSDSD1SD1S/esquema_colecciones.md)**: Modelo de datos Firestore de esta instancia.
