...
try {
    ...
    # Reiniciar el servidor Vite del subproyecto si fue detenido
    if ($viteWasStoppedSub -and (Test-Path $SubprojectPath)) {
        Write-Host "  [INFO] Reiniciando servidor de desarrollo Vite del subproyecto..." -ForegroundColor Cyan
