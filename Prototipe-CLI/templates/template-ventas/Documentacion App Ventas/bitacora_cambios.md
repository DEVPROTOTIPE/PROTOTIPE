...
* **Descripción de Cambios:**
  ...
  - **`firestore.rules`:** Restauradas las reglas de seguridad originales completas y sanas del commit `24c9908` y desplegadas al proyecto Firebase `proyecto-cliente-saas` para habilitar el login de cliente y analíticas.
* **Archivos modificados:**
...
* **Descripción de Cambios:**
  ...
  **A) Corrección crítica — Permisos de Notificaciones para Cliente:**
  ...
  - Desplegadas las nuevas reglas de Firestore en producción (`firebase deploy --only firestore:rules`). Proyecto: `proyecto-cliente-saas`.
