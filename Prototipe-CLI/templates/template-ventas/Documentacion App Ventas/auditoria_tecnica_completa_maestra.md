...
* **Servicios:** `accessLogService.js`, `adService.js`, `alertService.js`, `appConfigService.js`, `authService.js`, `billingService.js`, `claimsService.js`, `clientNotificationService.js`, `couponService.js`, `creditService.js`, `deliveryService.js`, `employeeService.js`, `favoritesService.js`, `inventoryService.js`, `notificationCenterService.js`, `notificationService.js`, `offlineDB.js`, `orderService.js`, `pdfService.js`, `productionService.js`, `qrAnalyticsService.js`, `stockMovementService.js`, `tableService.js`, `telemetryService.js`, `trackingAnalyticsService.js`, `uploadService.js`, `userService.js`, `whatsappService.js`, `wholesaleService.js`
* **Hooks:** `useAds.js`, `useAppConfigSync.js`, `useAuthInit.js`, `useBilling.js`, `useCopyToClipboard.js`, `useCoupons.js`, `useCredits.js`, `useFCMPermission.js`, `useInactivityTimer.js`, `useInventory.js`, `useNotificationCenter.js`, `useOrders.js`, `usePWAInstall.js`, `useProductVariants.js`, `useWholesale.js`
...
* **Componentes de Cliente:** `SoftPushPrompt.jsx`, `CartDrawer.jsx`, `CartDrawer.jsx.clean`, `CatalogBanner.jsx`, `ClientFilterModal.jsx`, `ProductCard.jsx`, `ProductDetailModal.jsx`, `WholesaleRequestModal.jsx`, `CheckoutModal.jsx`, `ClaimRequestModal.jsx`, `ClientCouponsModal.jsx`, `SmartHint.jsx`, `TableMenuBar.jsx`
...
* **Páginas (Fases 9 y 10):** `LoginPage.jsx`, `WelcomePage.jsx`, `ClientCatalog.jsx`, `ClientCredits.jsx`, `ClientFavorites.jsx`, `ClientOrders.jsx`, `ClientProfile.jsx`, `OrderTracking.jsx`, `ProductDetailPage.jsx`, `ProductPublicDetail.jsx`, `PortalAuth.jsx`, `PortalBodega.jsx`, `PortalCocina.jsx`, `PortalMensajero.jsx`, `PortalMesero.jsx`, `PortalVendedor.jsx`, `AdminClaims.jsx`, `AdminCredits.jsx`, `AdminDeliveryPerformance.jsx`, `AdminHome.jsx`, `AdminInventory.jsx`, `AdminNotificationAnalytics.jsx`, `AdminOrders.jsx`, `AdminPortalQR.jsx`, `AdminQRPerformance.jsx`, `AdminSales.jsx`, `AdminSalesDetail.jsx`, `AdminSettings.jsx`, `AdminStockAlerts.jsx`, `MobilePreview.jsx`, `AdSettings.jsx`, `AppearanceSettings.jsx`, `BrandSettings.jsx`, `CouponSettings.jsx`, `DeveloperBillingPanel.jsx`, `DeveloperSettings.jsx`, `EmployeeSettings.jsx`, `PaymentSettings.jsx`, `SecuritySettings.jsx`, `StoreSettings.jsx`
