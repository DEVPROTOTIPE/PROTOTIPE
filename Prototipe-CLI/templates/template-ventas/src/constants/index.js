...
export const PAYMENT_METHOD_LABELS = {
  ...
  online: 'Pago Seguro en Línea (Bold / Wompi / Mercado Pago)',
}
...
export const PAYMENT_METHOD_MESSAGES = {
  ...
  online: 'Paga de forma rápida y segura con tarjeta de crédito, PSE o QR.',
}
...
export const COLLECTIONS = {
  ...
  USERS: 'users',
  ORDERS: 'orders',
  ORDER_TRACKING: 'order_tracking', // [FASE 1] Colección pública de seguimiento (sin PII)
...
// [SEGURIDAD] El PIN se genera por proyecto desde el CLI y se escribe en VITE_DEV_PIN.
// Si no está definida la variable, la función de facturación queda deshabilitada.
// NUNCA agregar un fallback estático aquí: cualquier fork/clone heredaría la credencial.
export const DEV_PIN = import.meta.env.VITE_DEV_PIN ?? null
