...
import { useCreatePhysicalOrder } from '../../features/sales'
...
import { subscribeToVendedorOrders } from '../../features/orders'
...
export default function PortalVendedor() {
  ...
  useEffect(() => {
    ...
    const unsub = subscribeToVendedorOrders(portalEmployee.id, (data) => {
