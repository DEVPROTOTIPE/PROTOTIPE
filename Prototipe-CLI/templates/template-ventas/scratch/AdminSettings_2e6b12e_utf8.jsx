    ...
    >
      ...
      {!activeSection && (
        <div className="flex flex-col gap-4">
          ...
          {/* ÔöÇÔöÇ Tarjeta 1: Tienda ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          ...
          {/* ÔöÇÔöÇ Tarjeta 2: Gesti├│n ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden">
            <p className="text-[10px] font-black text-muted uppercase tracking-widest px-5 pt-4 pb-2">Gesti├│n</p>
          ...
          {/* ÔöÇÔöÇ Tarjeta 3: Sistema ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
          <div className="bg-surface rounded-3xl shadow-sm overflow-hidden">
      ...
      {/* ÔöÇÔöÇÔöÇ VISTA: PERSONALIZAR TIENDA ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      {/* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */}
      {activeSection === 'personalizar' && (
          <div className="bg-surface rounded-3xl border border-app shadow-sm flex flex-col relative">
            
            {/* SUBSECCI├ôN MENU: Cuadr├¡cula de Tarjetas Selectoras */}
            {activeSubSection === null && (
              <div className="p-6 space-y-6">
                <p className="text-sm text-muted">Selecciona una categor├¡a para comenzar a personalizar tu tienda:</p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-app text-sm mb-1 group-hover:text-primary transition-colors">Gesti├│n de Personal</p>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-app text-sm mb-1 group-hover:text-primary transition-colors">M├®todos de Entrega</p>
                      <p className="text-xs text-muted leading-relaxed">Establece retiros en local, env├¡os a domicilio, costos y entregas digitales.</p>
                    </div>
                    <ChevronRight size={18} className="text-muted shrink-0 mt-1.5 group-hover:text-primary transition-colors animate-pulse" />
                  </motion.button>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted leading-relaxed">Configura la cantidad m├¡nima, el tipo de descuento y el valor de mayoreo.</p>
                    </div>
                    <ChevronRight size={18} className="text-muted shrink-0 mt-1.5 group-hover:text-primary transition-colors animate-pulse" />
                  </motion.button>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted leading-relaxed">Activa temas visuales especiales (Navidad, Halloween, D├¡a de la Madre/Padre).</p>
                    </div>
                    <ChevronRight size={18} className="text-muted shrink-0 mt-1.5 group-hover:text-primary transition-colors animate-pulse" />
                  </motion.button>

                  {/* Tarjeta Garant├¡as y Reclamos */}
                  <motion.button
                    whileHover={{ scale: 1.01 }}
                    whileTap={{ scale: 0.98 }}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-app text-sm mb-1 group-hover:text-primary transition-colors">Garant├¡as y Reclamos</p>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted leading-relaxed">Permite a tus clientes seguir sus pedidos en tiempo real por WhatsApp sin iniciar sesi├│n.</p>
                    </div>
                    <ChevronRight size={18} className="text-muted shrink-0 mt-1.5 group-hover:text-primary transition-colors animate-pulse" />
                  </motion.button>

                  {/* Tarjeta Gesti├│n de M├│dulos (Feature Flags) */}
                  <motion.button
                    whileHover={{ scale: 1.01 }}
                    whileTap={{ scale: 0.98 }}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-bold text-app text-sm mb-1 group-hover:text-primary transition-colors">M├│dulos Activos</p>
                      <p className="text-xs text-muted leading-relaxed">Configura y activa/desactiva los m├│dulos del negocio (Cr├®dito, Reclamos, Cupones, Mayoreo).</p>
                    </div>
                    <ChevronRight size={18} className="text-muted shrink-0 mt-1.5 group-hover:text-primary transition-colors animate-pulse" />
                  </motion.button>
                </div>
            ...
            {/* SUBSECCI├ôN FORM: Gesti├│n de Personal */}
            {activeSubSection === 'empleados' && (
              <>
                <div className="p-5 sm:p-6 space-y-5">
                  <div className="flex items-center justify-between p-4 bg-surface-2 rounded-2xl border border-app">
                    <div>
                      <p className="text-sm font-bold text-app">M├║ltiples Empleados</p>
                      <p className="text-xs text-muted mt-0.5">Activa esta opci├│n si tu negocio cuenta con personal de ventas adem├ís de ti</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                      <input type="checkbox" className="sr-only peer"
                  ...
                  {formData.hasMultipleEmployees && (
                    ...
                    >
                      <div>
                        <label className="block text-sm font-bold text-app mb-2">N├║mero de Empleados</label>
                        <input
                          type="number"
                          min="1"
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        setSaveMessage({ type: 'success', text: 'Configuraci├│n de personal guardada correctamente.' })
                        setTimeout(() => setSaveMessage(null), 3000)
                      } catch (e) {
                    ...
                    className="w-full h-12 bg-primary text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-sm"
                  >
                    <Save size={18} /> Guardar Configuraci├│n de Personal
                  </button>
                </div>
              </>
            )}

            {/* SUBSECCI├ôN FORM: M├®todos de Entrega */}
            {activeSubSection === 'entregas' && (
              <>
                <div className="p-5 sm:p-6 space-y-5">
                  {/* Retiro en Local */}
                  <div className="p-4 bg-surface-2/60 rounded-2xl border border-app space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-muted">Permite al cliente retirar el pedido f├¡sicamente</p>
                      </div>
                    ...
                    {(formData.deliverySettings?.pickup?.enabled ?? true) && (
                      <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-3 pt-2">
                        <div>
                          <label className="block text-xs font-semibold text-muted mb-1">Direcci├│n de Retiro</label>
                          <input
                            type="text"
                        ...
                        <div>
                          ...
                          <input
                            ...
                            placeholder="Ej. Acercarse a caja con el n├║mero de pedido"
                            className="w-full h-11 px-4 rounded-xl bg-surface border border-app text-sm text-app focus:outline-none focus:border-primary transition-colors"
                          />
                        </div>
                      </motion.div>
                  ...
                  <div className="p-4 bg-surface-2/60 rounded-2xl border border-app space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-bold text-app">Env├¡o a Domicilio</p>
                        <p className="text-xs text-muted">Permite despachar pedidos a la direcci├│n del cliente</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer shrink-0">
                        <input type="checkbox" className="sr-only peer"
                    ...
                    {(formData.deliverySettings?.shipping?.enabled ?? true) && (
                      <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-3 pt-2">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-xs font-semibold text-muted mb-1">Costo de Env├¡o ($)</label>
                            <input
                              type="number"
                              min="0"
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-muted mb-1">Instrucciones de Env├¡o</label>
                          <input
                            type="text"
                ...
                <div className="p-5 border-t border-app bg-surface-2/30">
                  <button
                    onClick={async () => {
                      try {
                        ...
                        if (!pEnabled && !sEnabled && !dEnabled) {
                          setSaveMessage({ type: 'error', text: 'Debes habilitar al menos un m├®todo de entrega.' })
                          return;
                        }
                        ...
                        setSaveMessage({ type: 'success', text: 'M├®todos de entrega guardados correctamente.' })
                        setTimeout(() => setSaveMessage(null), 3000)
                      } catch (e) {
                        setSaveMessage({ type: 'error', text: 'Error al guardar.' })
                      }
                    ...
                    className="w-full h-12 bg-primary text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-sm"
                  >
                    <Save size={18} /> Guardar M├®todos de Entrega
                  </button>
                </div>
              </>
            )}

            {/* SUBSECCI├ôN FORM: Ventas al por Mayor */}
                ...
                <div className="p-5 sm:p-6 space-y-5">
                  <div className="flex items-center justify-between p-4 bg-surface-2 rounded-2xl border border-app">
                    <div>
                      ...
                      <p className="text-xs text-muted mt-0.5">Permite a los clientes solicitar cotizaciones y precios mayoristas en el cat├ílogo</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                      <input type="checkbox" className="sr-only peer"
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        setSaveMessage({ type: 'success', text: 'Configuraci├│n de venta al por mayor guardada correctamente.' })
                        setTimeout(() => setSaveMessage(null), 3000)
                      } catch (e) {
                    ...
                    className="w-full h-12 bg-primary text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-sm"
                  >
                    <Save size={18} /> Guardar Configuraci├│n de Mayoreo
                  </button>
                </div>
              </>
            )}

            {/* SUBSECCI├ôN FORM: Eventos por Temporada */}
            {activeSubSection === 'temporada' && (
              <>
                <div className="p-5 sm:p-6 space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[460px] overflow-y-auto p-2.5 pr-2">
                      {[
                        { id: 'none', label: 'Ninguno (Tema normal)', desc: 'Desactiva efectos visuales extras', emoji: 'Ô£¿', colors: [] },
                        { id: 'navidad', label: 'Navidad', desc: 'Rojos y verdes navide├▒os', emoji: '­ƒÄä', colors: ['#d32f2f', '#388e3c'] },
                        { id: 'halloween', label: 'Halloween', desc: 'Naranjas y morados m├ígicos', emoji: '­ƒÄâ', colors: ['#f57c00', '#7b1fa2'] },
                        { id: 'madre', label: 'D├¡a de la Madre', desc: 'Rosados y fucsias maternales', emoji: '­ƒî©', colors: ['#ec407a', '#ab47bc'] },
                        { id: 'padre', label: 'D├¡a del Padre', desc: 'Azul cl├ísico y gris cuero', emoji: '­ƒæö', colors: ['#0288d1', '#455a64'] },
                        { id: 'nino', label: 'D├¡a del Ni├▒o', desc: 'Amarillo alegre y celeste pastel', emoji: '­ƒº©', colors: ['#fbc02d', '#29b6f6'] },
                        { id: 'amistad', label: 'Amor y Amistad', desc: 'Rojos pasi├│n y rosa suave', emoji: 'ÔØñ´©Å', colors: ['#e91e63', '#f48fb1'] },
                        { id: 'verano', label: 'Verano', desc: 'Amarillo brillante y turquesa playa', emoji: 'ÔÿÇ´©Å', colors: ['#ffeb3b', '#00bcd4'] },
                        { id: 'semanasanta', label: 'Semana Santa', desc: 'Morados lit├║rgicos y blanco lino', emoji: '­ƒî¥', colors: ['#673ab7', '#eae6df'] },
                        { id: 'mascota', label: 'D├¡a de la Mascota', desc: 'Caf├®s y beige c├ílidos', emoji: '­ƒÉ¥', colors: ['#8d6e63', '#d7ccc8'] }
                      ].map((evt) => {
                  ...
                  {formData.activeSeasonalEvent && formData.activeSeasonalEvent !== 'none' && (
                    <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10 flex gap-3.5 items-start">
                      <div className="text-xl mt-0.5">Ôä╣´©Å</div>
                      <div className="text-xs text-muted leading-relaxed">
                        <p className="font-bold text-primary mb-0.5">Modo de Temporada Activo</p>
                        Esta opci├│n aplica una paleta de colores especial a toda la aplicaci├│n para tus clientes sin modificar tu tema base. Al desactivarlo, tu tienda volver├í a sus colores predefinidos.
                      </div>
                    </div>
                  )}
                </div>
            ...
            {/* SUBSECCI├ôN FORM: Garant├¡as y Reclamos */}
            {activeSubSection === 'garantias' && (
              <>
                <div className="p-5 sm:p-6 space-y-5">
                  <div className="flex items-center justify-between p-4 bg-surface-2 rounded-2xl border border-app">
                    <div>
                      <p className="text-sm font-bold text-app">Activar Garant├¡as y Reclamos</p>
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        setSaveMessage({ type: 'success', text: 'Configuraci├│n de garant├¡as guardada correctamente.' })
                        setTimeout(() => setSaveMessage(null), 3000)
                      } catch (e) {
                        setSaveMessage({ type: 'error', text: 'Error al guardar.' })
                      }
                    ...
                    className="w-full h-12 bg-primary text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-sm"
                  >
                    <Save size={18} /> Guardar Configuraci├│n de Garant├¡as
                  </button>
                </div>
              </>
            )}

            {/* SUBSECCI├ôN FORM: Seguimiento de Pedidos */}
                ...
                <div className="p-5 sm:p-6 space-y-5">
                  <div className="flex items-center justify-between p-4 bg-surface-2 rounded-2xl border border-app">
                    <div>
                      ...
                      <p className="text-xs text-muted mt-0.5">Habilita un portal p├║blico y genera enlaces de WhatsApp autom├íticos para que los clientes sigan sus pedidos en tiempo real</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer shrink-0 mt-1">
                      <input type="checkbox" className="sr-only peer"
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        setSaveMessage({ type: 'success', text: 'Configuraci├│n de seguimiento guardada correctamente.' })
                        setTimeout(() => setSaveMessage(null), 3000)
                      } catch (e) {
                        setSaveMessage({ type: 'error', text: 'Error al guardar.' })
                      }
                    ...
                    className="w-full h-12 bg-primary text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all shadow-sm"
                  >
                    <Save size={18} /> Guardar Configuraci├│n de Seguimiento
                  </button>
                </div>
              </>
            )}
