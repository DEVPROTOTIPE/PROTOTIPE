                  ...
                  <div className="p-4 bg-surface-2/60 rounded-2xl border border-app space-y-3">
                    ...
                    {(formData.deliverySettings?.pickup?.enabled ?? true) && (
                      <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-3 pt-2">
                        ...
                        <div className="mb-4">
                          <label className="block text-xs font-semibold text-muted mb-2">Ubicaci├│n del Local en el Mapa</label>
                          <LeafletMapPicker
                        ...
                        <div>
                          <label className="block text-xs font-semibold text-muted mb-1">Direcci├│n de Retiro (Manual)</label>
                          <input
                            type="text"
