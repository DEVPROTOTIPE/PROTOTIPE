...
const useAppConfigStore = create(
  persist(
    (set) => ({
      ...
      // ─── Apariencia avanzada ───────────────────────────────────────────
      appFont: getPersistedValue('appFont', import.meta.env.VITE_INITIAL_FONT || 'inter'),
      appRadius: getPersistedValue('appRadius', import.meta.env.VITE_INITIAL_RADIUS || 'rounded'),
