...
export const APP_CONFIG = {
  ...
  checkout: {
    ...
    contactStep: {
      /** data-testid del input de celular (selector robusto, evita colisión con login) */
      phoneTestId: 'checkout-phone-input',
      /** Selector fallback si el data-testid no está disponible en la instancia */
      phoneInputSelector: 'input[type="tel"]',
