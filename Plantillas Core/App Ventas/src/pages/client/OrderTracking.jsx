...
import OrderTrackingSkeleton from '../../components/ui/OrderTrackingSkeleton'
...
import { subscribeToOrderByToken } from '../../features/orders'
import {
  Package,
  CheckCircle2,
  CheckCircle,
...
export default function OrderTracking() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[var(--color-bg)] py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
