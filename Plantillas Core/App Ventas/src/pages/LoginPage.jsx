...
export default function LoginPage() {
  ...
  // Escuchar errores globales de autenticación (ej: falta de privilegios capturada por useAuthInit)
  useEffect(() => {
    if (authStoreError) {
      setError(authStoreError)
      setIsLoading(false)
  ...
  const handleAdminAuth = async (e) => {
    ...
    try {
      ...
      try {
        ...
        // Si el usuario no existe Y Firestore indica que no hay admin registrado, intentamos registrar
      ...
      // Si el admin ya está registrado en el estado local, delegamos la validación a useAuthInit.
      // Si no está registrado (primer arranque genuino), creamos el perfil del primer admin.
      // Las Firestore Rules (isFirstStart) garantizan que esta escritura solo se permita si
